import { Box, Button, Card, CardActions, CardContent, CardHeader, CardMedia, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Slide, Stack, SxProps } from "@mui/material";
import { Dog } from "../../api/shared/DogLookupInterfaces";
